...
import { getTopAdsByReachTool } from './tools';
...
const agent = createReactAgent({
  ...
  prompt:
    `# Role
      ...
      1. Use the getTopAdsByReachTool with the given company id to receive a list of image descriptions of the best ads of the company.
